...
<td>NO</td><td>Nama</td><td>Sekolah</td><td>J_K</td><td>TGL_L</td><td>NISN</td><td>NPSN</td><td>Kelas</td><td>NO KKS</td><td>IBU</td><td>AYAH</td><td>AKSI</td>
        <?php require_once"../db.php";$nom=1;
        $pdo=$amorpdo->prepare("select*from usulan ORDER BY KELAS ASC LIMIT 150");
        $pdo->execute();
        foreach ($pdo as $dkip){
        ?>

<tr>
<td><center><?php echo $nom++; ?></td>
