          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <!--<li><a href="javascript:void(0)" onclick="sperpartmasuk()"><i class="fa fa-circle-o"></i>Manage</a></li>-->
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="javascript:void(0)" onclick="pembelian_kel()"><i class="fa fa-circle-o"></i>Permintaan Beli</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
