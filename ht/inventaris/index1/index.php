          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="javascript:void(0)" onclick="sperpart()"><i class="fa fa-circle-o"></i>Daftar Barang</a></li>
                <li><a href="javascript:void(0)" onclick="sperpartmasuk()"><i class="fa fa-circle-o"></i>Barang Masuk</a></li>
                <li><a href="javascript:void(0)" onclick="pengeluaran()"><i class="fa fa-circle-o"></i>Barang Keluar</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="javascript:void(0)" onclick="pembelian()"><i class="fa fa-circle-o"></i>Permintaan Masuk</a></li>
