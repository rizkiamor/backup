...
?>
  ...
  <div class="btn-group">
  <a href="javascript:void(0)" onclick="user_edit(this.value);"><button type="button" class="btn btn-success">Ubah</button></a>
  <a href="javascript:void(0)" onclick="user_hapus(this.value);"><button type="button" class="btn btn-danger">Hapus</button></div></td>
  <td>	<input type="image" src="../images/option.png" height="43" width="45" value="<?php echo
$kode; ?>" alt="edit" onclick="edit_pembuat(this.value);" /></td>
</tr>
  <?php } ?>
  </table>
</div>
