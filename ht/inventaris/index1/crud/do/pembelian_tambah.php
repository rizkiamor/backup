...
<div class="container">
   ...
   <div class="form-group">
     ...
     ?>">
     Nomor_DO`, `Tanggal_DO`, `Nomor_permintaan`, `Kode_barang`, `Nomor_keluar`, `Jumlah`, `Satuan
   </div>
   <div class="form-group">
     <input type="hidden" class="form-control" id="namabarang" placeholder="Nomor DO"  value="<?php echo $beli['Nama_barang']; ?>">
   </div>
   <div class="form-group">
     <input type="hidden" class="form-control" id="jumlahbarang" placeholder="Nomor Permintaan"  value="<?php echo $beli['Jumlah']; ?>">
   </div>
   <div class="form-group">
